...
type Economics struct {
	...
	PrevEpochStartNonce uint64        `protobuf:"varint,8,opt,name=PrevEpochStartNonce,proto3" json:"PrevEpochStartNonce,omitempty"`
...
func (m *Economics) GetPrevEpochStartNonce() uint64 {
	if m != nil {
		return m.PrevEpochStartNonce
	}
	return 0
}
...
var fileDescriptor_87b91ab531130b2b = []byte{
	...
	,
}
...
func (this *Economics) Equal(that interface{}) bool {
	...
	if this.PrevEpochStartNonce != that1.PrevEpochStartNonce {
		return false
	}
...
func (this *Economics) GoString() string {
	...
	s = append(s, "PrevEpochStartNonce: "+fmt.Sprintf("%#v", this.PrevEpochStartNonce)+",\n")
...
func (m *Economics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PrevEpochStartNonce != 0 {
		i = encodeVarintMetaBlock(dAtA, i, uint64(m.PrevEpochStartNonce))
		i--
		dAtA[i] = 0x40
	}
...
func (m *Economics) Size() (n int) {
	...
	if m.PrevEpochStartNonce != 0 {
		n += 1 + sovMetaBlock(uint64(m.PrevEpochStartNonce))
	}
...
func (this *Economics) String() string {
	...
	s := strings.Join([]string{`&Economics{`,
		...
		`PrevEpochStartNonce:` + fmt.Sprintf("%v", this.PrevEpochStartNonce) + `,`,
...
func (m *Economics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevEpochStartNonce", wireType)
			}
			m.PrevEpochStartNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetaBlock
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrevEpochStartNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
