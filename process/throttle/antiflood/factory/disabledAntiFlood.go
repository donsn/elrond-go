...
func (daf *disabledAntiFlood) CanProcessMessage(_ p2p.MessageP2P, _ core.PeerID) error {
	return nil
}

// CanProcessMessageOnTopic will always return nil
func (daf *disabledAntiFlood) CanProcessMessageOnTopic(_ core.PeerID, _ string) error {
	return nil
}
